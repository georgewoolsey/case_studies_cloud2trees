...
We'll also load the `trees2ico` [package](https://github.com/georgewoolsey/trees2ico/tree/main) which was developed specifically for this use-case
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, include=FALSE}
remove(list = ls()[grep("_temp",ls())])
remove(custom_lin, itd_tuning_ans, timer_df, f, cloud2trees_ans)
gc()
```
